...
namespace Services.Storage
{
    public class AndroidLocalStorage : LocalStorage
    {
        public AndroidLocalStorage()
        {
            ...
            Debug.Log("AndroidLocalStorage: internal dir - " + _internalDirectory);
            Debug.Log("AndroidLocalStorage: external dir - " + _externalDirectory);
        }
        ...
        protected override IEnumerable<byte[]> LoadAllBackupFiles()
        {
            ...
            {
                Debug.Log("Loading backup file: " + name);
